  ...
  return (
    <section className="border-l-2 border-neutral-700 pl-4">
      ...
      <ul className="space-y-1.5 text-sm font-serif text-neutral-700">
        {longReceived > 0 ? (
          <li>
            <Link href="/manager?state=received&olderThan=24h&expanded=true" className="hover:underline">
        ...
        {longStored > 0 ? (
          <li>
            <Link href="/manager?state=stored&olderThan=30d&expanded=true" className="hover:underline">
        ...
        {oldRma > 0 ? (
          <li>
            <Link href="/manager?state=rma_pending&olderThan=14d&expanded=true" className="hover:underline">
